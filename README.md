...
|------|--------------|-----------|----------------|
| Project Manager | `claude-opus-4-8` | Cloud (Anthropic) | Blueprint planning — turns a feature request into a structured, strongly-typed implementation contract |
...
| Junior Developer | `minimax/MiniMax-M3` | Cloud (MiniMax) | Implementation — executes one PRD task at a time inside the Ralph loop |
